...
def query_data(engine, sql_query):
    """
    Create a connection object and query the database, and return df
...
def read_from_web_CSV(URL):
    """
    Read a CSV file from a URL and return a DataFrame

    Arguments:
    URL: the URL of the CSV file

    Returns:
    df: the DataFrame created from the CSV file
    """
    try:
        df = pd.read_csv(URL)
